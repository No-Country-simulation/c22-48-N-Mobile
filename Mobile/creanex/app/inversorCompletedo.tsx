...
const InversorCompletado = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.subtitle}>Tu inversión ha sido creada con éxito</Text>

            {/* Botón para volver al inicio */}
            <TouchableOpacity
                style={styles.backButton}
                onPress={() => router.push('/inversorHome')} // Cambia esta ruta según tu configuración
            >
...
export default InversorCompletado;
